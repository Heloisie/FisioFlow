...
class _InitialPageState extends State<InitialPage> {
  final List<Exercise> items = [
    ...
    Exercise('abdominal', 'assets/abdominal.webp',
        'A corrida é um excelente exercício cardiovascular que ajuda a melhorar a resistência e queimar calorias. Encontre um ritmo confortável e mantenha a postura.'),
  ];
    ...
    return Expanded(
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _handleHorizontalWorkOutList();
            }));
  }

  Widget _handleHorizontalWorkOutList() {
    return SizedBox(
      height: 300,
      child: ListView.builder(
